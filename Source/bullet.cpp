...
bullet::bullet(std::string s, sf::Vector2f newPosition, int damage , sf::Vector2f direction, sf::Color color, sf::Vector2f size):
color ( color ),
size ( size ),
...
void bullet::update(sf::Vector2f delta){
    position += direction;
...
bool bullet::collision(screen_object & obj)
{
